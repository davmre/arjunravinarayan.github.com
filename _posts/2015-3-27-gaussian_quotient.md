...
`$(d, D)$`---is the same as you would have gotten by plugging in the negated covariance `$-B$` to the product formula above; in this sense, dividing by a Gaussian is like multiplying by a Gaussian with *negative variance*. This
